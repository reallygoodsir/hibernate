...
public class Configuration {
    ...
    public static EntityManagerFactory createEntityManagerFactory() {
        var registry = new StandardServiceRegistryBuilder()
                ...
                .applySetting("hibernate.connection.url", "jdbc:mysql://localhost:3306/jpa_annotations_advanced")
        ...
        var metadata = new MetadataSources(registry)
                .addAnnotatedClass(ProductReview.class)
                .addAnnotatedClass(ReviewMappingEntity.class)
                .addAnnotatedClass(ProductReviewGraph.class)
                .buildMetadata();
